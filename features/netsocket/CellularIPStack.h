...
#ifndef MBED_OS_CELLULARSTACK_H_
#define MBED_OS_CELLULARSTACK_H_

#include "mbed.h"
#include "NetworkStack.h"

class CellularIPStack : public NetworkStack {
public:
    static CellularIPStack *get_stack();
...
private:
    static CellularIPStack * _cellular_stack;
};



#endif /* MBED_OS_CELLULARSTACK_H_ */
